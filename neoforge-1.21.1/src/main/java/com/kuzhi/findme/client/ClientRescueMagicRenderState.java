...
public final class ClientRescueMagicRenderState {
    ...
    static final class Effect {
        ...
        private void beginBurst(Minecraft minecraft, Vec3 current, Vec3 direction) {
            ...
            minecraft.level.playLocalSound(current.x, current.y, current.z, SoundEvents.GENERIC_EXPLODE.value(),
                    SoundSource.NEUTRAL, 0.52f, 1.28f, false);
            minecraft.level.playLocalSound(current.x, current.y, current.z, SoundEvents.WIND_CHARGE_BURST.value(),
