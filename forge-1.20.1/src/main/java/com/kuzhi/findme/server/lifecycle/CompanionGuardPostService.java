...
public final class CompanionGuardPostService {
    ...
    public static void acquireHome(Mob mob, BlockPos center, CompanionMoveType moveType,
        ...
        double patrolRadius = patrolRadius(mob, homePatrolRadius(residentMode, Config.housePatrolRadius));
        double hardRadius = hardRadius(mob, homeHardRadius(patrolRadius, Config.houseHardRadius));
