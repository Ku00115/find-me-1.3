...
public record RescueMagicPacket(int entityId, double x, double y, double z, float radius, float height, float yaw, int durationTicks, Style style, Purpose purpose, Visual visual) {
