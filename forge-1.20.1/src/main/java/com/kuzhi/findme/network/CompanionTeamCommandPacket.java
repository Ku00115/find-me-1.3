...
public record CompanionTeamCommandPacket(CompanionTeamAction action, CompanionTeamTarget target, int teamIndex, int secondaryIndex, String value, List<UUID> uuids) {
